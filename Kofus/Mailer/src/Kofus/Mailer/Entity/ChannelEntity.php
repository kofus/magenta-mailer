 ...
 */
class ChannelEntity implements Node\NodeInterface, Node\EnableableNodeInterface
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
	...
	/**
	 * @ORM\ManyToMany(targetEntity="Kofus\Mailer\Entity\MailEntity", mappedBy="channels")
	 * @var array
	 */
